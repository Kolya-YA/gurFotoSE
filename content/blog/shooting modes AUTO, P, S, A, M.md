...
*Хорошо, если вы уже познакомились со статьей* ["**Экспозиционный треугольник: как ISO, выдержка и диафрагма создают фотографию**"](https://gurfoto.ru/blog/exposure-triangle/) *и имеете представление об "экспозиции" и ее параметрах.*
...
- **P** — Programmed Auto: автоматический выбор выдержки и диафрагмы с возможностью смещения баланса между ними.
