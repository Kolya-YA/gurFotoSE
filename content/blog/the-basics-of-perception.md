...
> *Если вам недостаточно почерпнутых в интернете рун о том, "как сделать фотографии выразительными", стоит найти ответы на вопросы, которые вы стыдились задать...*  
**Автор**

## Вступление

*Фотография – один из способов передать идею с помощью визуального образа ─ это Фотография. Способ далеко не единственный, есть еще живопись, скульптура, танец, и это, если не принимать в расчет музыку, пантомиму... можно вспомнить и другие человеческие занятия, но в этой статье речь пойдет только о ***Фотографии***.*
...
- Знакомство с некоторыми особенностями оценки окружающего мира черз призму *гештальт-психологии*, науки, исследующей механизмы восприятия, и принципов реконструкции пространства из изображения на плоскости. Также разберемся как именно в нашем сознании формируется иллюзия трехмерного пространства, изображенного на фотоснимке или картине.
...
Эти четыре шага повторяются все время, пока зритель концентрирует свое внимание на изображении, в это заключается основное отличие человеческого восприятия от принципов работы любого регистрирующего прибора: человеческое восприятие **не одномоментно**!

> *Приведу в качестве примера фотографию А.Битесниха, для зрителя имеющего определенный культурны бэкграун, это художественое произведение, он отметит, что красивая обнаженная женщина, своей позой выражает раздумье, неуверенность, напряжение, узкий длинный коридор, в котором она находится, давит на нее, заставляя выбрать направление, темные прямогульники на полу коридора задают ритм, в который героиня не вписывается, коридор заставляет ее выбрать одно из двух направлений, ограничивая свободу выбора... одним словом, весьма драматичная история, о которой рассказывает автор.*
...
На изображении вверху приведены рисунки, иллюстрирующие двойственность восприятия согласно гештальт-принципам, а фотография Э.Эрвитта, ниже, позволяет оценить использование фотографом сразу нескольких принципов: *простоты*, *близости* и *схожести*.
...
В данном случае, любые объяснения излишний, всякому человеку понятна идея этой работы... не скажу, что впервые встречаю фотографию на тему "Связь поколений", но должен сказать, что всегда чувствую волнение... как всякий человек, минимально наделенный эмпатией.  
...
На классическом кадре Анри Картье-Брессона, где мужчина прыгнул через лужу, его силуэт почти сливается с тёмным фоном. Однако «чистое» отражение в воде создаёт завершённый образ прыжка: мозг автоматически заполняет недостающие детали, используя для этого отражение.
...
Пара обменивается поцелуем в автомобиле, рама зеркала обрезает части фигур, но зритель интуитивно завершает силуэты, воссоздавая интимность момента.
...
- создавать интригу: оставляя часть объекта вне кадра или в тени, они побуждают зрителя «достроить» недостающие элементы, что делает изображение более захватывающим.
- упрощать композицию: изображая только контуры или фрагменты объекта, можно избежать излишней детализации, сохраняя при этом узнаваемость формы.
...
Диагональная дорога, пересекающиеся фигуры людей и их тени формируют непрерывную траекторию, втягивая зрителя в движение группы.
...
Композиция помещения музея с центрально расположенным полотном и равномерно расставленными фигурами посетителей воплощает симметрию архитектуры и экспозиции.
...
Фотографы используют этот принцип для создания динамики и управления взглядом зрителя. Например, группа бегущих спортсменов или стая птиц в полете воспринимаются как один объект ─ это усиливает эмоциональное воздействие. Даже если объекты различны по форме или цвету, их общее движение объединяет их в сознании.
...
Зелёные глаза девушки резко сочетаются с размытым фоном и контрастируя оттенком накидк, мгновенно фокусируя внимание на лице.
...
Силуэты детей на светлом фоне обеспечивают легкую и естественную "читаемость" и эмоциональную простоту кадра.
...
Оновные принципы ***гештальт-психологии*** мы уже обсудили, нужно лишь добавить, что очевидное нарушение этих принципов, может быть использовано как инструмент, меняющий восприятие, например, нарушение принципа "*Сходство*" может привлечь внимание к определённому элементу, создавая акцент.
...
Автомобильная гонка снята с медленной выдержкой, превращая движущиеся объекты в разноцветные «размазанные» следы, создавая эстетический ритм.
...
Наступил момент, когда стоит обсудить то, как теоретические знания об основах визуального восприятия можно использовать для создания снимков, способных вызывать сильный эмоциональный отклик.
...
Эти приёмы позволяют усилить ощущение глубины и пространственной организации кадра. Применение *принципа разделения планов* способствует созданию выразительных изображений, с реалистичным ощущением объема.
...
{{< imgr src="the-basics-of-perception/the-basics-of-perception72.jpg" alt="Статуя Свободы, Нью-Йорк. Автор Garry Winogrand" >}}
*G.Winogrand*  
...
***Ключевой момент:*** *этот материал написан фотографом для фотографов. Наша задача — научиться анализировать, прежде всего, собственные снимки. Поэтому текст должен быть коротким и понятным: несколько ёмких предложений о выразительности и визуальном качестве работы помогут в дальнейшем рационально оценваить фотографии.*
...
- **Симметрия:** почти абсолютная симметрия говорит о спокойствии, за которым, возможно, сконцентрирован большой запас эмоциональной энергии, усиливается это ощущение контрастом между эмроциями, выраженными лицами и позами девушек.
...
**Повторение:** в первую очередь ступени, однознажно задают ритм... и это довольно распространенный прием, когда зрителю задается некоторый ритм, независимо от того, соответствует ли он идее произведения в целом. Далее на ритм ступеней наложен другой ритм ─ ноги и руки, повторяющие дуг друга. Мелодия ритма стала немного сложней, а значит чуть интересней.
...
**Ведущие линии:** диагональные линии в фоне взаимодействуют с вертикалью тела. Есть еще диагонали, образованные ног и мягкие линии плеч, в целом, конструкция воспринимается через контраст вертикальных и горизонтальных линий, в качестве последних воспринимаются очень слабые диагонали, составляющие контуры ручья и дороги.

**Геометрия:** прежде всего в глаза бросается неустойчивое равовесие в кадре, обусловленной вертикалями в фигуре девушки ─ это распространенная конструкция для демонстрации неустойчивого состояния. В сравнении с центральной фигурой остальные контрастные переходы воспринимаются довольно тяжело, взгляду сложно адаптироваться к тональностям в которых изображен ландшафт от почти максимальных тональных значений в центральной фигуре. Нужно добавить, что ветки деревьев вокруг сохдают некоторый хаос линий, но не пересекают и не "вростают" в контур фигуры. Ветки над головой девушки "давят" и даже есть ощущение, что наклон головы ─ результат этого давления.
...
- **Реализация:** использование двух источников света: заполняющего и бокового (моделирующего). Видимо по замыслу автора, источник рисующего света является доминирующим, поэтому экспозиция от него дает практически "пересвеченный" результат... вполне возможно, мое впечатление основано на недостаточно качественном файле, который я сохранил из сети. Интерьер сцены состоит из стопки матрасов, подобранных по цвету и находящихся в гармонии с фоном. Две девушки в черном и белом белье и это все ─ очень минималистичный снимок.
...
Все не однозначно. С одной стороны, есть идея и есть ее реализация.
...
Анализ показал... не буду повторять то, что уже написал об этом снимке, есть важный вывод, который следует из написанного... в фотографии всегда две важные сущности, которые делают работу фотографа осмысленной и плодотворной: идея и ее визуальное представление. Если эти сущности присутствуют и их сочетание гармонично и пропорционально, то работа состоялась. Каждый выбирает пропорции, в которых эти начала присутствуют в его работах.
